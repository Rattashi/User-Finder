...
read -p $'\e[1;92m[\e[0m\e[1;77m>\e[0m\e[1;92m] Aranan Kullanıcı Adı Girin:\e[0m ' username

if [[ -e $username.txt ]]; then
printf "\e[1;92m[\e[0m\e[1;77mX\e[0m\e[1;92m] Kaldırılacak Önceki Dosya:\e[0m\e[1;77m %s.txt" $username
rm -rf $username.txt
fi
printf "\n"
printf "\e[1;92m[\e[0m\e[1;77m>\e[0m\e[1;92m] Kullanıcı Aranıyor...\e[0m\e[1;77m %s\e[0m\e[1;92m on: \e[0m\n" $username

## INSTAGRAM

check_insta=$(curl -s -H "Accept-Language: en" "https://www.instagram.com/$username" -L | grep -o 'Takip Ettiğiniz Link Bozuk Olabilir.'; echo $?)
...
printf "\e[1;92m Bulundu!\e[0m https://www.patreon.com/%s\n" $username
...
printf "\e[1;92m Bulundu!\e[0m https://keybase.io/%s\n" $username
